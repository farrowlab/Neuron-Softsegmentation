...
def flatten(im, iterations=4, exp_factor=11):
	...
	assert np.max(F.ravel())<=1.1, 'Overflattening: Decrease exp_factor hyperparameter!'
...
if __name__ == '__main__':
	...
	im_flat = flatten(im, 4, 3) # 3 works quit egood for natural images, 10 for confocal
